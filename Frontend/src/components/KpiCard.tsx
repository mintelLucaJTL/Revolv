...
export default function KpiCard({ variant, badgeLabel, smallLabel, value, percent, onClick }: Props) {    // Wähle die passenden CSS-Klassen für die gewählte Variant-Farbe.
  ...
  return (
    ...
    >
      ...
      <CardContent className="p-0">   {/* badgeLabel: kleiner Hinweis oben (z. B. "ÜBER 25%") */}
        {badgeLabel && (
          <Box className="mb-2">
